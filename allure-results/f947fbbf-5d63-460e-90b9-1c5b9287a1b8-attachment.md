...
- Name: API\accountsAPI.spec.ts >> TC-04 Validate Account Data Types
- Location: tests\API\accountsAPI.spec.ts:38:5
  ...
  - generic [ref=e2]:
    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e44]:
        ...
        - table [ref=e48]:
          - rowgroup [ref=e49]:
            - 'row "First Name: Dhruvil" [ref=e50]':
              - cell "First Name:" [ref=e51]
              - cell "Dhruvil" [ref=e52]:
                - textbox [ref=e53]: Dhruvil
              - cell [ref=e54]
            - 'row "Last Name: Gautam" [ref=e55]':
              - cell "Last Name:" [ref=e56]
              - cell "Gautam" [ref=e57]:
                - textbox [ref=e58]: Gautam
              - cell [ref=e59]
            - 'row "Address: anupam apartments" [ref=e60]':
              - cell "Address:" [ref=e61]
              - cell "anupam apartments" [ref=e62]:
                - textbox [ref=e63]: anupam apartments
              - cell [ref=e64]
            - 'row "City: Jaipur" [ref=e65]':
              - cell "City:" [ref=e66]
              - cell "Jaipur" [ref=e67]:
                - textbox [ref=e68]: Jaipur
              - cell [ref=e69]
            - 'row "State: Rajasthan" [ref=e70]':
              ...
              - cell [ref=e74]
            - 'row "Zip Code: 302071" [ref=e75]':
              - cell "Zip Code:" [ref=e76]
              - cell "302071" [ref=e77]:
                - textbox [ref=e78]: "302071"
              - cell [ref=e79]
            - 'row "Phone #: 1234567890" [ref=e80]':
              ...
              - cell [ref=e84]
            - 'row "SSN: 1781338640536" [ref=e85]':
              - cell "SSN:" [ref=e86]
              - cell "1781338640536" [ref=e87]:
                - textbox [ref=e88]: "1781338640536"
              - cell [ref=e89]
            - row [ref=e90]:
              - cell [ref=e91]
            - 'row "Username: datatype1781338638609 This username already exists." [ref=e92]':
              - cell "Username:" [ref=e93]
              - cell "datatype1781338638609" [ref=e94]:
                - textbox [ref=e95]: datatype1781338638609
...
```ts
  ...
  5  | 
  6  |   async openNewAccountPage() {
> 7  |     await this.page.getByRole("link", { name: "Open New Account" }).click();
     |                                                                     ^ Error: locator.click: Test timeout of 30000ms exceeded.
  8  |   }
  9  | 
  10 |   async createAccount(accountType: string) {
  11 |     await this.page.locator("#type").selectOption(accountType);
  12 |     await this.page.locator("#fromAccountId").selectOption({ index: 0 });
  13 |     await this.page.locator('input[value="Open New Account"]').click();
  14 |     await expect(this.page.locator("#newAccountId")).toBeVisible();
  15 |     const accountId = await this.page.locator("#newAccountId").innerText();
  16 |     return accountId;
  17 |   }
  18 | }
  19 | 
